    ...
    <div style={{background:"#020B18",color:"#F0F4FF",fontFamily:"system-ui,sans-serif",minHeight:"100vh"}}>
      ...
      <section style={{maxWidth:900,margin:"0 auto",padding:"100px 24px 72px",textAlign:"center"}}>
        <div style={{display:"inline-flex",alignItems:"center",gap:8,background:"#3B82F618",border:"1px solid #3B82F635",borderRadius:40,padding:"6px 20px",fontSize:12,fontWeight:700,color:"#3B82F6",letterSpacing:"0.12em",textTransform:"uppercase",marginBottom:28}}>
          ...
          AI Revenue Workforce — LenderPulse
        </div>
        ...
        <div style={{display:"flex",gap:14,justifyContent:"center",flexWrap:"wrap"}}>
          <a href="/pricing" style={{background:"#3B82F6",color:"#020B18",border:"none",borderRadius:8,padding:"16px 36px",fontSize:16,fontWeight:800,textDecoration:"none",display:"inline-block"}}>Start Free Trial →</a>
      ...
      <section style={{maxWidth:700,margin:"0 auto",padding:"88px 24px",textAlign:"center"}}>
        ...
        <div style={{display:"flex",gap:14,justifyContent:"center",flexWrap:"wrap"}}>
          <a href="/pricing" style={{background:"#3B82F6",color:"#020B18",padding:"18px 48px",borderRadius:8,fontWeight:800,textDecoration:"none",display:"inline-block",fontSize:17}}>Start Free Trial →</a>
